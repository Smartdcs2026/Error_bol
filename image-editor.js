...
//     const json = canvas.toDatalessJSON(["toolType", "effectType", "arrowStroke", "arrowStrokeWidth", "arrowX1", "arrowY1", "arrowX2", "arrowY2"]);
...
//     const line = new fabric.Line([lx1, ly1, lx2, ly2], {
//       stroke: editorState.strokeColor,
//       strokeWidth: editorState.strokeWidth,
//       selectable: false,
//       evented: false,
...
//     const x1 = Number(group.arrowAbsX1 ?? 0);
//     const y1 = Number(group.arrowAbsY1 ?? 0);
//     const x2 = Number(group.arrowAbsX2 ?? 0);
//     const y2 = Number(group.arrowAbsY2 ?? 0);

//     const stroke = group.arrowStroke || editorState.strokeColor;
//     const strokeWidth = Math.max(1, Number(group.arrowStrokeWidth || editorState.strokeWidth || 1));
...
//       Math.abs(group.scaleX || 1),
//       Math.abs(group.scaleY || 1)
//     );

//     const strokeWidth = Math.max(
//       1,
//       Number((group.arrowStrokeWidth || line.strokeWidth || editorState.strokeWidth || 1) * scaleFactor)
//     );
...
//     group.arrowAbsX1 = p1.x;
//     group.arrowAbsY1 = p1.y;
//     group.arrowAbsX2 = p2.x;
//     group.arrowAbsY2 = p2.y;
//     group.arrowStroke = stroke;
//     group.arrowStrokeWidth = strokeWidth;
...
(function () {
  ...
  function prepareModalShell() {
    ...
    modal.classList.remove("hidden", "is-ready");
  ...
  function resetModalState() {
    ...
    modal.classList.remove("is-opening", "is-ready");
  ...
  async function openImageEditor(file, options = {}) {
    ...
    if (editorState.isOpening || editorState.isVisible) {
      return Promise.resolve({ ok: false, reason: "EDITOR_BUSY" });
    }
