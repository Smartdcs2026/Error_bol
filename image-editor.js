...
(function () {
  ...
  function ensureFabricReady() {
    if (!window.fabric || !window.fabric.Canvas) {
      throw new Error("ไม่พบ Fabric.js");
    }
  }
  ...
  function bindUiOnce() {
    ...
    if (window.visualViewport) {
      window.visualViewport.addEventListener("resize", scheduleStableResize, { passive: true });
      window.visualViewport.addEventListener("scroll", scheduleStableResize, { passive: true });
    }
  }
